...
namespace AssetManagement.Tests
{
    public class BootstrapTests
    {
        ...
        public async Task GetUserBootstrap_ReturnsOkResultWithData()
        {
            ...
            InitializeTestDatabase(connection);
            ...
            Assert.Contains(dto.DashboardForms, f => f.FormType == "widget" || f.FormType == "standard");
        }

        private static void InitializeTestDatabase(SqliteConnection connection)
        {
            ...
            cmd.CommandText = @"
                ...
                INSERT INTO x_locales (locale_code, display_name, is_default, is_active) VALUES ('en-US', 'English', 1, 1);
                ...
                INSERT INTO x_site_nav_link_locales (nav_id, locale_code, label) VALUES ('e8a719c2-570a-4a2e-9d2a-8d7d91e84321', 'en-US', 'Inbox & Dashboard');
